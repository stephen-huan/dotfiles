/*!
  Highlight.js v11.9.0 (git: 6618a0e09e)
...
const f="[a-zA-Z]\\w*",E="[a-zA-Z_]\\w*",w="\\b\\d+(\\.\\d+)?",y="(-?)(\\b0[xX][a-fA-F0-9]+|(\\b\\d+(\\.\\d*)?|\\.\\d+)([eE][-+]?\\d+)?)",v="\\b(0b[01]+)",N={
...
let w={};function y(a,r){const o=r&&r[0];if(A+=a,null==o)return d(),0
...
;const x=Q(v);let k="",O=r||x;const M={},S=new p.__emitter(p);(()=>{const e=[]
...
;T=e.index+n}y(t.substring(T))}return S.finalize(),k=S.toHTML(),{language:e,
...
y&&v()}),!1),Object.assign(t,{highlight:h,highlightAuto:E,highlightAll:v,
highlightElement:w,
highlightBlock:e=>(H("10.7.0","highlightBlock will be removed entirely in v12.0"),
H("10.7.0","Please use highlightElement now."),w(e)),configure:e=>{p=Y(p,e)},
initHighlighting:()=>{
...
const _e="[A-Za-z$_][0-9A-Za-z$_]*",he=["as","in","of","if","for","while","finally","var","new","function","do","return","void","else","break","catch","instanceof","with","throw","case","default","try","switch","continue","typeof","delete","let","yield","const","class","debugger","async","await","static","import","from","export","extends"],fe=["true","false","null","undefined","NaN","Infinity"],Ee=["Object","Function","Boolean","Symbol","Math","Date","Number","BigInt","String","RegExp","Array","Float32Array","Float64Array","Int8Array","Uint8Array","Uint8ClampedArray","Int16Array","Int32Array","Uint16Array","Uint32Array","BigInt64Array","BigUint64Array","Set","Map","WeakSet","WeakMap","ArrayBuffer","SharedArrayBuffer","Atomics","DataView","JSON","Promise","Generator","GeneratorFunction","AsyncFunction","Reflect","Proxy","Intl","WebAssembly"],we=["Error","EvalError","InternalError","RangeError","ReferenceError","SyntaxError","TypeError","URIError"],ye=["setInterval","setTimeout","clearInterval","clearTimeout","require","exports","eval","isFinite","isNaN","parseFloat","parseInt","decodeURI","decodeURIComponent","encodeURI","encodeURIComponent","escape","unescape"],ve=["arguments","this","super","console","window","document","localStorage","sessionStorage","module","global"],Ne=[].concat(ye,Ee,we)
;function xe(e){const n=e.regex,t=_e,a={begin:/<[A-Za-z0-9\\._:-]+/,
...
className:"title.class",keywords:{_:[...Ee,...we]}},y={variants:[{
match:[/function/,/\s+/,t,/(?=\s*\()/]},{match:[/function/,/\s*(?=\()/]}],
className:{1:"keyword",3:"title.function"},label:"func.def",contains:[f],
illegal:/%/},v={
match:n.concat(/\b/,(N=[...ye,"super","import"],n.concat("(?!",N.join("|"),")")),t,n.lookahead(/\(/)),
...
PARAMS_CONTAINS:h,CLASS_REFERENCE:w},illegal:/#(?![$_A-z])/,
contains:[e.SHEBANG({label:"shebang",binary:"node",relevance:5}),{
label:"use_strict",className:"meta",relevance:10,
begin:/^\s*['"]use (strict|asm)['"]/
},e.APOS_STRING_MODE,e.QUOTE_STRING_MODE,d,g,u,b,m,{match:/\$\d+/},l,w,{
...
},e.C_LINE_COMMENT_MODE,e.C_BLOCK_COMMENT_MODE]},me,r]}},grmr_javascript:xe,
...
className:"link",begin:/:\s*/,end:/$/,excludeBegin:!0}]}]}},grmr_nix:e=>{
const n={
...
className:"attr",begin:/\S+/,relevance:.2}]}];return t.contains=i,{name:"Nix",
aliases:["nixos"],keywords:n,contains:i}},grmr_objectivec:e=>{
...
begin:/\?>/}]},{scope:"variable.language",match:/\$this\b/},r,y,f,{
...
}),w=(e="")=>({className:"subst",match:b(/\\/,e,/[\t ]*(?:[\r\n]|\r\n)/)
}),y=(e="")=>({className:"subst",label:"interpol",begin:b(/\\/,e,/\(/),end:/\)/
}),v=(e="")=>({begin:b(e,/"""/),end:b(/"""/,e),contains:[E(e),w(e),y(e)]
}),N=(e="")=>({begin:b(e,/"/),end:b(/"/,e),contains:[E(e),y(e)]}),x={
className:"string",
...
contains:[{begin:/\(/,end:/\)/,keywords:Pe,contains:[...p,f,x]}]}},{
...
;n.keywords=l;const t=[...c,...g,...p,f,x,...C];n.contains=[...t,{begin:/\(/,
...
},S,...c,...g,...p,f,x,...C,...T,R,I]}},grmr_typescript:e=>{
const n=xe(e),t=_e,a=["any","void","number","boolean","string","object","never","symbol","bigint","unknown"],i={
...
contains:[l]}]}},grmr_vim:e=>({name:"Vim Script",keywords:{$pattern:/[!#@\w]+/,
